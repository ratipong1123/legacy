  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
        ...
        <br>
     <center>
         <h1 style="font-size: 2em;">Welcome To Legacy Gangs</h1>
         <h1 style="font-size: 1em;">Always respect others even if other people don't respect.</h1>
    </center>
